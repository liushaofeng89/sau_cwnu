...
<!DOCTYPE html><s:set name="menu_value" value="'settings'"/>
<html lang="en">
<head>
<meta charset="utf-8">
...
<title>个人设置 - 大学生社团联合会网站后台管理系统</title>
				...
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-8">
						<div class='form-group'>
							<label class="label-light">昵称</label> <input class="form-control" type="text" placeholder="<s:property value="#session.USER_LOGIN_SESSION_INFO.nickName" />" name="nickName" id="nickName" />
						</div>
						<div class='form-group'>
						...
						<div class='form-group'>
							<label class="label-light">邮箱</label> <input class="form-control" required="required" type="email" placeholder="<s:property value="#session.USER_LOGIN_SESSION_INFO.mail" />" name="mail" id="mail" /> <span class='help-block'>活动通知方式</span>
						</div>
						<div class='form-group'>
							<label class="label-light">微信</label> <input class="form-control" required="required" type="text" placeholder="<s:property value="#session.USER_LOGIN_SESSION_INFO.weixin" />" name="weixin" id="weixin" /> <span class='help-block'>简洁的风格，没有广告才是我最爱她的原因</span>
						</div>
						<div class='form-group'>
							<label class="label-light">QQ</label> <input class="form-control" required="required" type="text" placeholder="<s:property value="#session.USER_LOGIN_SESSION_INFO.qq" />" name="qq" id="qq" /> <span class='help-block'>QQ依然是一种很受欢迎的聊天方式</span>
						</div>
					</div>
